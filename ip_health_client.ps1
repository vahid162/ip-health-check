...
$IPs = @(
  "45.76.81.223","192.248.186.235","136.244.94.164","95.179.165.28","199.247.18.240",
  "209.250.233.165","95.179.170.149","45.77.65.108","80.240.27.66","45.32.155.187"
)

# Optional: if you have hostnames pointing to some IPs, map for SNI tests:
$SniMap = @{
...
if (-not $OpenSSL) { Write-Host "Note: OpenSSL not found; TLS tests (TLS1.2/1.3/SNI/ALPN) will be skipped." }
